...
namespace Controllers
{
    public class UserController : BaseController
    {
        ...
        public JsonResult LogOn(string username, string password)
        {
            try
            {
                ...
                if (userManager.ValidateUser(user, password))
                {
                    ...
                    return Json(new { LogOnResult = "Success", id = user.id, Success = true });
        ...
        */
        ...
        /// requestObjects can contain any of the following strins:
        ///     firstName, lastName, title, school, description, tagLine, resume, profilePicture, profilePictureThumbnail, stats, links, experiences, references, tags, projects, todo, recentActivity
        /// </summary>
